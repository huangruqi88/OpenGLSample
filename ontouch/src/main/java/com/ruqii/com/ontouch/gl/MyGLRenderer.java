...
import com.ruqii.com.ontouch.gl.view.Square;
import com.ruqii.com.ontouch.gl.view.Triangle;
...
public class MyGLRenderer implements GLSurfaceView.Renderer {
    ...
    public volatile float mAngle = 3.0f;
...
//        float angle = 0.090f * ((int) time);
        ...
        // 将旋转矩阵与投影和摄像机视图相结合
        // 注意：mMVPMatrix因子*must be first* 即必须是第一个使矩阵的乘积得到正确的结果
